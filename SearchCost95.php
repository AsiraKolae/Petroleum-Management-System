        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    การคำนวณราคาต่อหน่วย (แก๊สโซฮอล์ 95)
                    </h2>
    ...
    <li class="nav-item">
      <a class="nav-link" href="SearchCostB7.php">ต้นทุนดีเซล B7</a>
            ...
            
          {
             ...
             $B_price95 = $data["B_price95"];
             $COST95 = $data["COST95"];
             $sum = $sum + $data["Amount95"];
             $sum0 = $sum0 + $data["COST95"];
             $sum1 =$sum1+ $data["COST950"];
          ?>
                <tr>
                  <td>
                ...
                <td style="text-align:right;"><?php echo number_format($Amount95)."<br />";?></td>
                <td style="text-align:right;"><?php echo $data["B_price95"];?></td>
                <td style="text-align:right;"><?php echo number_format($COST95)."<br />";?></td>
                </tr>
                </tr>           
<?php
}
