...
<?php
   ...
   $sql = "SELECT *
          ...
          --  ,ROUND(SUM(AmountB7)*(B_priceB7)) AS COSTB70
    ...
    <li class="nav-item">
      <a class="nav-link" href="SearchCostB7.php">ต้นทุนดีเซล B7</a>
              ...
              while($data=mysqli_fetch_array($query,MYSQLI_ASSOC))
          {
             ...
             $B_priceB7 = $data["B_priceB7"];
             $COSTB7 = $data["COSTB7"];
             $sum = $sum + $data["AmountB7"];
             $sum0 = $sum0 + $data["COSTB7"];
             $sum1 =$sum1+ $data["COSTB70"];
          ...
          ?>
                ...
                <td style="text-align:right;"><?php echo number_format($AmountB7)."<br />";?></td>
                <td style="text-align:right;"><?php echo $data["B_priceB7"];?></td>
                <td style="text-align:right;"><?php echo number_format($COSTB7)."<br />";?></td>
                </tr>
                </tr>           
<?php
}
