...
<?php
  ...
  -- ,ROUND(SUM((S_price95)*((NumEnd_list95-NumStart_list95)+(NumEnd_listT95-NumStart_listT95)+(NumEnd_listTR95-NumStart_listTR95)))) AS SalesAll
          ...
          ,ROUND((S_price95)*((NumEnd_list95-NumStart_list95)+(NumEnd_listT95-NumStart_listT95)+(NumEnd_listTR95-NumStart_listTR95)),2) AS SalesAll95
          ,ROUND((S_price95)*((NumEnd_list91-NumStart_list91)+(NumEnd_listT91-NumStart_listT91)+(NumEnd_listTR91-NumStart_listTR91)),2) AS SalesAll91
          ,ROUND((S_price95)*((NumEnd_listB7-NumStart_listB7)+(NumEnd_listTB7-NumStart_listTB7)+(NumEnd_listTRB7-NumStart_listTRB7)),2) AS SalesAllB7
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-7"><h2>ยอดขายน้ำมันในแต่ละวัน (แยกตามประเภทน้ำมัน)</h2>
      ...
      <a class="nav-link" href="SearchProfit.php">กำไร</a>
            ...
            <table class="table table-striped table-hover" style="margin-left:0%;">
                <!-- <thead> -->
                  ...
                  <td style="text-align:center;">จำนวนจ่าย (ลิตร)</td>
                  <td style="text-align:center;">ราคาขาย</td>
                  <td style="text-align:center;">ยอดขาย</td>
                  </tr>
                  <?php
          $n=0;
              ...
              // $_i++;
          {
            ...
            $SalesAll95 = $data["SalesAll95"];
            $SalesAll91 = $data["SalesAll91"];
            $SalesAllB7 = $data["SalesAllB7"];
                ...
                <tr>
                  ...
                  <td>
                    <div style="text-align:right;">
                     ...
                     <td style="text-align:right;"><?php echo $data["B_price95"];?></td>
                     <td style="text-align:right;"><?php echo number_format($SalesAll95,2)."<br />";?></td>
          </tr>
                </tr> 
                ...
                <tr>
                  ...
                  <td>
                    <div style="text-align:right;">
                     ...
                     <td style="text-align:right;"><?php echo number_format($SalesAll91,2)."<br />";?></td>
          </tr>
                </tr> 
                ...
                <tr>
                  ...
                  <td>
                    <div style="text-align:right;">
                     ...
                     <td style="text-align:right;"><?php echo $data["B_priceB7"];?></td>
                     <td style="text-align:right;"><?php echo number_format($SalesAllB7,2)."<br />";?></td>
          </tr>
                </tr> 
...
*หมายเหตุ : แสดงยอดขายน้ำมันในแต่ละวัน โดยแยกตามประเภทน้ำมัน และแสดงที่มาของยอดขาย
</div>
<br>
<footer>
