...
<?php
   ...
   $sql = "SELECT *
          ...
          //  WHERE Date_Bprice95 
          //  LIKE '%".$strKeyword."%'
          //  ORDER BY Date_Bprice95 DESC LIMIT 9";
...
&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
<a href="FormBuyPriceAdd.php" type="button" class="btn btn-success"><i class="fa fa-plus" style="font-size:16px"></i>&nbsp;&nbsp;เพิ่มข้อมูล</a>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-7"><h2>ราคาน้ำมัน (ราคาซื้อ)</h2></div>
      ...
      <a class="nav-link" href="SalePrice.php">ราคาขาย</a>
            ...
            <table class="table table-striped table-hover" style="margin-left:0%;">
                <!-- <thead> -->
                  <tr>
                    ...
                    <td style="text-align:center;">ราคาซื้อ (บาท/ลิตร)</td>
                    <td colspan="2">
                    <center>
                       <div class="container">
          ...
          ?>
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $data["B_price95"];?></td>

                        <td style="text-align:center;"><a class="btn btn-primary" href="EditBuyPrice95.php?Date_Bprice95=<?php echo $data['Date_Bprice95'];?>">แก้ไข</a></td>
                        <!-- <td style="text-align:center;"><a class="btn btn-danger" href="DeleteBuyPrice.php?Date_Bprice95=<php echo $data['Date_Bprice95']; ?>">ลบ</a></td> -->
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $data["B_price91"];?></td>

                        <td style="text-align:center;"><a class="btn btn-primary" href="EditBuyPrice91.php?Date_Bprice91=<?php echo $data['Date_Bprice91'];?>">แก้ไข</a></td>
                        <!-- <td style="text-align:center;"><a class="btn btn-danger" href="DeleteBuyPrice.php?Date_Bprice95=<php echo $data['Date_Bprice95']; ?>">ลบ</a></td> -->
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $data["Date_BpriceB7"];?></td>
                        <td style="text-align:center; background-color:rgba(255, 206, 86, 1)"><?php echo $data["Petrol_typeIDB7"];?></td>
                        <td style="text-align:center;"><?php echo $data["B_priceB7"];?></td>

                        <td style="text-align:center;"><a class="btn btn-primary" href="EditBuyPriceB7.php?Date_BpriceB7=<?php echo $data['Date_BpriceB7'];?>">แก้ไข</a></td>
                        <!-- <td style="text-align:center;"><a class="btn btn-danger" href="DeleteBuyPrice.php?Date_Bprice95=<php echo $data['Date_Bprice95']; ?>">ลบ</a></td> -->
...
*หมายเหตุ : ตารางนี้แสดงราคาซื้อเฉพาะวันที่ปัจจุบัน-ย้อนหลัง 2 วันเท่านั้น สามารถทำการค้นหาวันที่ที่ต้องการได้
</div>
</body>
</html> 
