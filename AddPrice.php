<?php
	...
	// if ($B_price95!=''){
		...
		// mysqli_query($conn, "insert into `Sprice` (Date_Sprice95,Petrol_typeID95,S_price95) 
...
-- LEFT JOIN price ON price.Date_price = bprice95.Date_Bprice95
-- LEFT JOIN spriceb7 ON spriceb7.Date_SpriceB7 = bpriceb7.Date_BpriceB7 AND bpriceb7.Petrol_typeIDB7 = spriceb7.Petrol_typeIDB7 
...
// $sql9 = " INSERT INTO price
// (`Date_price`)
// VALUES
// ('$Date_Bprice95'),
// ";
// $result7 = mysqli_query($conn, $sql9) or die ("Error in query: $sql9" . mysqli_error());
...
echo "<script type='text/javascript'>";
echo "window.location = 'FormPriceAdd.php'; ";
echo "</script>";
}
