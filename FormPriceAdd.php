...
<div class="container py-5">
  ...
  <div class="row mb-4">
    ...
    <!-- class="display-6" -->
    <br>
      <h1>ฟอร์มเพิ่มรายการราคาน้ำมัน</h1>
    </div>
  </div>
  <!-- End -->
          ...
          <div id="nav-tab-card" class="tab-pane fade show active">
            <form role="form"  action="AddPrice.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-inline">
               ...
               &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
               <!-- <label for="Petrol_typeID0">รหัสประเภทน้ำมัน :</label> -->
               ...
               &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
               <!-- <label for="Petrol_typeID1">รหัสประเภทน้ำมัน :</label> -->
              ...
              <!-- <div class="form-group">
                <label for="Petrol_typeID0">รหัสประเภทน้ำมัน :</label>
                <input type="text" class="form-control" name="Petrol_typeID0" value="แก๊สโซฮอล์ 91" disabled>
               <input type="hidden" class="form-control" name="Petrol_typeID0" value="แก๊สโซฮอล์ 91">
              </div> -->
              ...
              <!-- <div class="form-group">
                <label for="Petrol_typeID1">รหัสประเภทน้ำมัน :</label>
                <input type="text" class="form-control" name="Petrol_typeID1" value="ดีเซล B7" disabled>
               <input type="hidden" class="form-control" name="Petrol_typeID1" value="ดีเซล B7">
              </div> -->
