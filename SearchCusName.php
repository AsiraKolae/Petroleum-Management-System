...
<form style="position: relative; left: 235px; top:15;" name="frmSearch" method="post" action="<?php echo $_SERVER['SCRIPT_NAME'];?>" style="position: relative; left: 140px;">
      ...
      <select name="txtKeyword" type="text" id="txtKeyword" value="<?php echo $strKeyword;?>">
            ...
            <option style="text-align:center;">บริษัทยาง</option>
            <option style="text-align:center;">บริษัทไม้</option>
            <option style="text-align:center;">บุคคลทั่วไป</option>
      </select>&nbsp;
...
<?php
   ...
   $sql = "SELECT * FROM customer_name WHERE Company_name LIKE '%".$strKeyword."%' ";
...
<tr>
    ...
    <td style="text-align:center;">วันที่รับ</td>
    <td style="text-align:center;">ชื่อบริษัท/สังกัด</td>
    <td style="text-align:center;">ชื่อประเภทน้ำมัน</td>
    <td style="text-align:center;">ชื่อผู้รับ</td>
    <td style="text-align:center;">จำนวน(บาท)</td>
    <td colspan="2">
    <center>
      <div class="container">
...
?>
  <tr>
    ...
    <td style="text-align:center;"><?php echo $data["Date_cus"];?></td>
    ...
    <td style="text-align:center;"><a class="btn btn-danger" href="DeleteCus.php?CusNameID=<?php echo $data['CusNameID']; ?>">ชำระ</a></td>
