...
<div class="container">
  ...
  <li class="nav-item">
      <a class="nav-link active" href="SearchCostAll.php">สรุปยอดขายน้ำมัน</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="SearchCostB7.php">ต้นทุนดีเซล B7</a>
            ...
            <table class="table table-striped table-hover" style="margin-left:0%;">
                  ...
                  <td style="text-align:center;">ประเภทน้ำมัน</td>
                  <td style="text-align:center;">ปริมาณน้มันที่จ่ายไป (ลิตร)</td>
          ...
          <tr>
                ...
                <td style="text-align:right;"><?php echo $data["Petrol_typeID95"];?></td>
                <td style="text-align:right;"><?php echo $data["totalAll95"];?></td>
                <td style="text-align:right;"><?php echo number_format($sum950/$sum95,2)."<br />";?></td>
                <td style="text-align:right;"><?php echo number_format(($sum950/$sum95)*($totalAll95))."<br />";?></td>
                </tr>
                </tr>
                ...
                <td style="text-align:center;"><?php echo $data["Date_Bprice95"];?></td>
                <td style="text-align:right;"><?php echo $data["Petrol_typeID91"];?></td>
                <td style="text-align:right;"><?php echo $data["totalAll91"];?></td>
                <td style="text-align:right;"><?php echo number_format($sum910/$sum91,2)."<br />";?></td>
                <td style="text-align:right;"><?php echo number_format(($sum910/$sum91)*($totalAll91))."<br />";?></td>
                </tr>
                </tr> 
                ...
                <td style="text-align:center;"><?php echo $data["Date_Bprice95"];?></td>
                <td style="text-align:right;"><?php echo $data["Petrol_typeIDB7"];?></td>
                <td style="text-align:right;"><?php echo $data["totalAllB7"];?></td>
                <td style="text-align:right;"><?php echo number_format($sumB70/$sumB7,2)."<br />";?></td>
                <td style="text-align:right;"><?php echo number_format(($sumB70/$sumB7)*($totalAllB7))."<br />";?></td>
                </tr>
                </tr>            
                <?php
}
