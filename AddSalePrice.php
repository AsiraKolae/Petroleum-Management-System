<?php
	...
	// 	mysqli_query($conn,"insert into `Bprice95` (Date_Bprice95,Petrol_typeID95,B_price95) 
	// 						values ('$Date_Bprice95','$Petrol_typeID95','$B_price95')");	
	// 	mysqli_query($conn, "insert into `Sprice95` (Date_Sprice95,Petrol_typeID95,S_price95) 
	// 					 values ('$Date_Bprice95','$Petrol_typeID95','$S_price95')");	
...
echo "window.location = 'SalePrice.php'; ";
echo "</script>";
}else{
echo "<script type='text/javascript'>";
echo "window.location = 'FormSalePriceAdd.php'; ";
echo "</script>";
}
